...
static int decode_exec(Decode *s) {
  ...
  word_t shamt = BITS(s->isa.inst.val, 24, 20);
  s->dnpc = s->snpc;
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(rd) = ((int)src1) >> shamt); 
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(rd) = (int)src1 >> (src2 & 0b11111));
