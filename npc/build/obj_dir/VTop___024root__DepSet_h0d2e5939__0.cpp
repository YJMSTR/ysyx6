...
#endif
                VL_FATAL_MT("build/Top.sv", 85, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("build/Top.sv", 85, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("build/Top.sv", 85, "", "NBA region did not converge.");
            }
